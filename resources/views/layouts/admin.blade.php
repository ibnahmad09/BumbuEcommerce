...
<body class="bg-gray-100">
    <div class="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div id="sidebar-overlay"
            class="lg:hidden fixed inset-0 bg-black/50 z-40 transition-opacity duration-300 opacity-0 pointer-events-none">
        </div>

        <!-- Sidebar -->
        <div id="sidebar"
            class="bg-white/20 backdrop-blur-lg w-72 min-h-screen shadow-xl border-r border-white/10 transform transition-all duration-300 lg:translate-x-0 -translate-x-full fixed lg:relative z-50">
            <div class="p-6">
            ...
            <nav class="mt-6">
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center px-6 py-3 text-gray-600 hover:bg-white/30 hover:text-gray-900 transition-all duration-300 group">
                    <div
                        class="w-1 h-8 bg-transparent rounded-r-lg group-hover:bg-green-500 transition-all duration-300">
                    </div>
                    <svg class="w-5 h-5 mr-3 text-gray-500 group-hover:text-green-500" fill="none"
                ...
                <a href="{{ route('products.index') }}"
                    class="flex items-center px-6 py-3 text-gray-600 hover:bg-white/30 hover:text-gray-900 transition-all duration-300">
                ...
                <a href="{{ route('order.index') }}"
                    ...
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 10h.01M12 10h.01M16 10h.01M9 15h.01M13 15h.01M17 15h.01M9 19h.01M13 19h.01M17 19h.01">
                        </path>
                    </svg>
                    Pesanan
                </a>
            ...
            <nav class="bg-white/30 backdrop-blur-lg shadow-sm sticky top-0 z-50">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16 items-center">
                        ...
                        <button class="lg:hidden p-2 text-gray-500 hover:text-gray-700 focus:outline-none"
            ...
            <div class="fixed bottom-4 right-4 space-y-2">
                @foreach (auth()->user()->unreadNotifications as $notification)
                    <div class="bg-white rounded-lg shadow-lg p-4 max-w-sm">
                        ...
                        <a href="{{ $notification->data['url'] }}" class="text-green-600 hover:text-green-700">Lihat Produk</a>
                    </div>
                @endforeach
            </div>
