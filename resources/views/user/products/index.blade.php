        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col sm:flex-row gap-4">
                <input type="text" placeholder="Cari produk..."
                    class="w-full sm:w-64 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-600">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                @foreach ($products as $product)
                    <!-- Pada bagian card produk, ubah link untuk menuju detail produk -->
                    <div
                        ...
                        <a href="{{ route('user.products.show', $product->id) }}">
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-green-600 font-bold mb-4">Rp
                                    {{ number_format($product->price, 0, ',', '.') }}</p>
                            </div>
                        </a>
                        <!-- Tombol tambah ke keranjang tetap di luar link -->
                        @if ($product->stock > 0)
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            showNotification('Produk berhasil ditambahkan ke keranjang', data
                                .total_price);
                        } else {
            ...
            function showNotification(message, totalPrice) {
                ...
                notification.className =
                    'fixed bottom-4 right-4 bg-white rounded-lg shadow-lg p-6 max-w-sm transform transition-all duration-300 translate-x-full';
