...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-800 mb-4">Kategori Unggulan</h2>
            <p class="text-lg text-gray-600">Temukan berbagai kategori bumbu pilihan kami</p>
        </div>
        ...
        <div class="flex overflow-x-auto pb-4 -mx-4 px-4">
            <div class="flex space-x-4">
                ...
                <a href="{{ route('user.products.index', ['category' => $category->id]) }}"
                   class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 group flex-shrink-0 px-6 py-3 border border-gray-200 hover:border-green-600">
                    <div class="flex items-center space-x-2">
                        <h3 class="text-lg font-semibold text-gray-800 group-hover:text-green-600 transition-colors duration-300">{{ $category->name }}</h3>
                        <span class="bg-green-100 text-green-800 text-sm px-2 py-1 rounded-full">{{ $category->products_count }} Produk</span>
                    </div>
                </a>
                @endforeach
            </div>
